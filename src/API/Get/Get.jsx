...
const Get = {
  appleData: (page) => {
    return `https://newsapi.org/v2/everything?q=apple&from=2022-08-22&to=2022-08-22&sortBy=popularity&page=${page}&pageSize=10&apiKey=cd5989874f8649ebb2dca88790fc68e4`;
  },
  teslaData: (page) => {
    return `https://newsapi.org/v2/everything?q=tesla&from=2022-07-23&sortBy=publishedAt&page=${page}&pageSize=10&apiKey=cd5989874f8649ebb2dca88790fc68e4`;
  },
